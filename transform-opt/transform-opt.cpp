//===-- transform-opt.cpp - Transform dialect entry point -----------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This is the top-level file for the Transform dialect extension SConv.
//
//===----------------------------------------------------------------------===//
...
int main(int argc, char **argv) {
  ...
  return mlir::MlirOptMain(argc, argv, "transform-opt", registry)
                 .succeeded()
             ? EXIT_SUCCESS
             : EXIT_FAILURE;
}
